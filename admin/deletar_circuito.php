...
<html lang="pt-BR">
    <head>
        ...
        <!-- Page Title -->
        <title>Deletar Circuito | Painel Vá DF</title>
        <!-- Main CSS -->			
    ...
    <body>
        ...
        <!-- User Singin Start -->
        <!--================================-->			
        <h1> Deletar Circuito</h1>
        <div class="ht-100v d-flex">
            <div class="card shadow-none pd-100 mx-auto wd-1000 bd-1">
                <form method="POST">                   
                    <div class="form-group input-group">
                        <label for="nome"> Nome </label>
                        <select class="form-control" id="circuito_nome" name="nome" onchange="select_name()">
                            <option selected value=''></option>
                            <option value="Circuito três poderes">Circuito três poderes</option>
                          </select>
                    </div>
                    <div id="circuito_info">
                        <div class="form-group input-group">
...
<script>
    ...
    function select_name(){
        if(document.getElementById('circuito_nome').value){
            $('#circuito_info').show();
        }else{
            $('#circuito_info').hide();
        };
